...
//        getActionBar().setDisplayHomeAsUpEnabled(false);
    ...
    private void setupActionBar() {
        ...
        if (actionBar != null) {
            // Show the Up button in the action bar.a
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || NotificationPreferenceFragment.class.getName().equals(fragmentName)||AboutPreferenceFragment.class.getName().equals(fragmentName);
    }
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            timeIntervalListPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object o) {
                    ...
                    Log.d("value string",String.valueOf(Integer.parseInt(value)*60*1000));
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
    ...
    public static class AboutPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            builder.setTitle(R.string.pref_about_open_source_license_title);
            builder.setIcon(R.drawable.ic_info_outline_black_24dp);
            builder.setView(R.layout.content_open_source_license_dialog);
            builder.setPositiveButton("OK",null);

            final AlertDialog dialog = builder.create();

            Preference dialogPreference = getPreferenceScreen().findPreference(getResources().getString(R.string.pref_about_open_source_license));
